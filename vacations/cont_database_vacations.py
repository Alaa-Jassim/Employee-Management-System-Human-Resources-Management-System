...
from vacations.management_database_vacations import database_vacations_employee
from insert_employee.management_database import database_path_management
from management_destination.management_exe import copy_resources_to_destination
...
class DataBaseVacations:
	...
	def create_database_vacations(self):
		self.connection = sqlite3.connect(database_vacations_employee("database_vacations.db"))
	...
	def check_id_exists(self):
		...
		self.connection_id_exists = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def check_email_exists(self):
		...
		self.connection_email_exists = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def confirm_data_vacation(self):
		...
		self.connection_date = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def save_data(self):
		self.connection_insert = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def update_data_vacations(self):
		if not os.path.exists(copy_resources_to_destination("database_vacations", "database_vacations.db")):
			raise FileNotFoundError(f"The Path Not Found Error")



		self.connection_update_table = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def delete_data_vacations(self):
		...
		self.connection_delete = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def show_data_vacations(self):
		self.connection_show = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
	...
	def search_employee_vacations(self):
		...
		self.connection_search = sqlite3.connect(copy_resources_to_destination("database_vacations", "database_vacations.db"))
